...
use KarlMonson\Magic\Facades\Magic;
...
trait AuthenticatesUsers
{
    ...
    public function login(Request $request)
    {
        ...
        $response = $this->broker()->sendLoginLink(
    ...
    public function magic(Request $request)
    {
        ...
        if ($this->attemptLogin($request)) {
            $this->broker()->login($this->credentials($request));
    ...
    protected function attemptLogin(Request $request)
    {
        return $this->guard()->attempt(
            $this->credentials($request), $request->session()->get('remember')
        );
    }
    ...
    /**
     * Get the broker to be used during authentication.
     *
     * @return \CartHero\Magic\MagicBroker
     */
